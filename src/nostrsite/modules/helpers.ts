...
import prevNext from "../../ghost/frontend/helpers/prev_post";
import raw from "../../ghost/frontend/helpers/raw";
...
import tags from "../../ghost/frontend/helpers/tags";
...
export const initHelpers = (hbs: ThemeEngine) => {
  ...
  registerHelper(hbs, "prev_post", prevNext);
  registerHelper(hbs, "next_post", prevNext);
  registerHelper(hbs, "raw", raw);
